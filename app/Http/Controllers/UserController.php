...
class UserController extends Controller
{
    ...
    {
        $this->middleware('permission:show all books|show all categories', ['only' => ['index','show']]);
        //  $this->middleware('permission:create book', ['only' => ['create','store']]);
        //  $this->middleware('permission:edit book', ['only' => ['edit','update']]);
         $this->middleware('permission:add to favorite|rate book', ['only' => ['destroy']]);
    ...
    public function index(Request $request)
    {
        if(Auth::user()->role_name == ['user']){
            ...
            $category = Category::all();
             return view('home',compact('book','category'));
         }   
